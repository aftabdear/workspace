...
public class Areas {
	...
	public static Position[] pathDQToBank = {
		    new Position(2946, 3450, 0),
		    new Position(2947, 3440, 0),
		    new Position(2948, 3430, 0),
		    new Position(2949, 3423, 0),
		    new Position(2954, 3414, 0),
		    new Position(2959, 3405, 0),
		    new Position(2964, 3396, 0),
		    new Position(2965, 3395, 0),
		    new Position(2967, 3385, 0),
		    new Position(2969, 3378, 0),
		    new Position(2979, 3376, 0),
		    new Position(2983, 3375, 0),
		    new Position(2992, 3370, 0),
		    new Position(3001, 3365, 0),
		    new Position(3010, 3360, 0),
		    new Position(3012, 3359, 0),
		    new Position(3011, 3355, 0)
		};
	
	public static Position[] pathBToRJ = {
		    new Position(3275, 3373, 0),
		    new Position(3285, 3375, 0),
		    new Position(3287, 3375, 0),
		    new Position(3290, 3377, 0),
		    new Position(3291, 3387, 0),
		    new Position(3291, 3387, 0),
		    new Position(3290, 3397, 0),
		    new Position(3289, 3407, 0),
		    new Position(3289, 3412, 0),
		    new Position(3282, 3420, 0),
		    new Position(3275, 3428, 0),
		    new Position(3275, 3428, 0),
		    new Position(3265, 3428, 0),
		    new Position(3255, 3428, 0),
		    new Position(3245, 3428, 0),
		    new Position(3238, 3429, 0),
		    new Position(3228, 3429, 0),
		    new Position(3218, 3429, 0),
		    new Position(3208, 3429, 0),
		    new Position(3204, 3428, 0),
		    new Position(3194, 3429, 0),
		    new Position(3184, 3430, 0),
		    new Position(3174, 3431, 0),
		    new Position(3165, 3433, 0)
		};
	
	public static Position[] pathRJToDQ4 = {
		    new Position(3212, 3428, 0),
		    new Position(3202, 3428, 0),
		    new Position(3192, 3428, 0),
		    new Position(3182, 3428, 0),
		    new Position(3173, 3428, 0),
		    new Position(3166, 3426, 0),
		    new Position(3160, 3419, 0),
		    new Position(3150, 3417, 0),
		    new Position(3143, 3416, 0),
		    new Position(3133, 3416, 0),
		    new Position(3131, 3416, 0),
		    new Position(3121, 3418, 0),
		    new Position(3120, 3418, 0),
		    new Position(3112, 3420, 0),
		    new Position(3102, 3419, 0),
		    new Position(3092, 3418, 0),
		    new Position(3086, 3418, 0),
		    new Position(3076, 3417, 0),
		    new Position(3072, 3417, 0),
		    new Position(3068, 3411, 0),
		    new Position(3061, 3404, 0),
		    new Position(3054, 3397, 0),
		    new Position(3046, 3391, 0),
		    new Position(3036, 3391, 0),
		    new Position(3026, 3391, 0),
		    new Position(3024, 3392, 0),
		    new Position(3016, 3397, 0),
		    new Position(3008, 3402, 0),
		    new Position(3000, 3407, 0),
		    new Position(2992, 3412, 0),
		    new Position(2984, 3417, 0),
		    new Position(2976, 3422, 0),
		    new Position(2968, 3427, 0),
		    new Position(2960, 3432, 0),
		    new Position(2952, 3437, 0),
		    new Position(2947, 3442, 0),
		    new Position(2949, 3450, 0)
		};
	
	public static Position[] pathRJToDQ3 = {
		    new Position(3212, 3428, 0),
		    new Position(3202, 3428, 0),
		    new Position(3192, 3428, 0),
		    new Position(3182, 3428, 0),
		    new Position(3173, 3428, 0),
		    new Position(3166, 3421, 0),
		    new Position(3164, 3420, 0),
		    new Position(3154, 3417, 0),
		    new Position(3154, 3417, 0),
		    new Position(3144, 3417, 0),
		    new Position(3134, 3417, 0),
		    new Position(3134, 3416, 0),
		    new Position(3124, 3414, 0),
		    new Position(3122, 3414, 0),
		    new Position(3116, 3420, 0),
		    new Position(3106, 3420, 0),
		    new Position(3096, 3420, 0),
		    new Position(3086, 3420, 0),
		    new Position(3084, 3420, 0),
		    new Position(3074, 3417, 0),
		    new Position(3070, 3416, 0),
		    new Position(3067, 3407, 0),
		    new Position(3058, 3402, 0),
		    new Position(3054, 3400, 0),
		    new Position(3045, 3403, 0),
		    new Position(3036, 3407, 0),
		    new Position(3035, 3407, 0),
		    new Position(3025, 3410, 0),
		    new Position(3015, 3413, 0),
		    new Position(3005, 3416, 0),
		    new Position(2995, 3419, 0),
		    new Position(2985, 3422, 0),
		    new Position(2975, 3425, 0),
		    new Position(2965, 3428, 0),
		    new Position(2955, 3431, 0),
		    new Position(2947, 3435, 0),
		    new Position(2948, 3445, 0),
		    new Position(2949, 3450, 0)
		};
	
	public static Position[] pathRJToDQ2 = {
		    new Position(3212, 3428, 0),
		    new Position(3202, 3428, 0),
		    new Position(3192, 3428, 0),
		    new Position(3182, 3428, 0),
		    new Position(3175, 3428, 0),
		    new Position(3166, 3424, 0),
		    new Position(3157, 3420, 0),
		    new Position(3148, 3416, 0),
		    new Position(3145, 3416, 0),
		    new Position(3135, 3416, 0),
		    new Position(3125, 3416, 0),
		    new Position(3121, 3415, 0),
		    new Position(3116, 3420, 0),
		    new Position(3106, 3420, 0),
		    new Position(3096, 3420, 0),
		    new Position(3086, 3420, 0),
		    new Position(3086, 3419, 0),
		    new Position(3076, 3417, 0),
		    new Position(3072, 3416, 0),
		    new Position(3063, 3415, 0),
		    new Position(3053, 3417, 0),
		    new Position(3043, 3419, 0),
		    new Position(3040, 3419, 0),
		    new Position(3032, 3426, 0),
		    new Position(3032, 3426, 0),
		    new Position(3022, 3426, 0),
		    new Position(3016, 3426, 0),
		    new Position(3007, 3430, 0),
		    new Position(2997, 3431, 0),
		    new Position(2995, 3431, 0),
		    new Position(2987, 3425, 0),
		    new Position(2982, 3421, 0),
		    new Position(2973, 3426, 0),
		    new Position(2964, 3431, 0),
		    new Position(2955, 3436, 0),
		    new Position(2947, 3441, 0),
		    new Position(2949, 3450, 0)
		};
	
	public static Position[] pathRJToDQ1 = {
		    new Position(3212, 3428, 0),
		    new Position(3202, 3428, 0),
		    new Position(3192, 3428, 0),
		    new Position(3182, 3428, 0),
		    new Position(3174, 3428, 0),
		    new Position(3167, 3421, 0),
		    new Position(3164, 3418, 0),
		    new Position(3154, 3417, 0),
		    new Position(3146, 3416, 0),
		    new Position(3136, 3417, 0),
		    new Position(3126, 3418, 0),
		    new Position(3119, 3418, 0),
		    new Position(3114, 3420, 0),
		    new Position(3104, 3420, 0),
		    new Position(3094, 3420, 0),
		    new Position(3087, 3420, 0),
		    new Position(3078, 3423, 0),
		    new Position(3072, 3425, 0),
		    new Position(3065, 3421, 0),
		    new Position(3055, 3418, 0),
		    new Position(3050, 3417, 0),
		    new Position(3041, 3420, 0),
		    new Position(3038, 3421, 0),
		    new Position(3031, 3426, 0),
		    new Position(3021, 3428, 0),
		    new Position(3012, 3429, 0),
		    new Position(3002, 3429, 0),
		    new Position(2992, 3429, 0),
		    new Position(2988, 3428, 0),
		    new Position(2987, 3421, 0),
		    new Position(2978, 3425, 0),
		    new Position(2972, 3427, 0),
		    new Position(2962, 3429, 0),
		    new Position(2958, 3430, 0),
		    new Position(2949, 3435, 0),
		    new Position(2948, 3436, 0),
		    new Position(2949, 3446, 0),
		    new Position(2949, 3450, 0)
		};
	
	public static Position[] CAToBerries2 = {
		    new Position(3208, 3214, 0),
		    new Position(3208, 3210, 0),
		    new Position(3215, 3211, 0),
		    new Position(3215, 3218, 0),
		    new Position(3225, 3218, 0),
		    new Position(3235, 3218, 0),
		    new Position(3236, 3218, 0),
		    new Position(3231, 3226, 0),
		    new Position(3226, 3234, 0),
		    new Position(3221, 3241, 0),
		    new Position(3218, 3251, 0),
		    new Position(3216, 3260, 0),
		    new Position(3226, 3261, 0),
		    new Position(3230, 3261, 0),
		    new Position(3240, 3261, 0),
		    new Position(3241, 3261, 0),
		    new Position(3240, 3271, 0),
		    new Position(3239, 3281, 0),
		    new Position(3238, 3284, 0),
		    new Position(3239, 3294, 0),
		    new Position(3240, 3304, 0),
		    new Position(3240, 3306, 0),
		    new Position(3247, 3313, 0),
		    new Position(3254, 3320, 0),
		    new Position(3257, 3323, 0),
		    new Position(3266, 3327, 0),
		    new Position(3268, 3328, 0),
		    new Position(3269, 3338, 0),
		    new Position(3270, 3344, 0),
		    new Position(3272, 3349, 0),
		    new Position(3272, 3359, 0),
		    new Position(3272, 3369, 0),
		    new Position(3272, 3372, 0)
		};
	
	public static Position[] CAToBerries1 = {
		    new Position(3208, 3214, 0),
		    new Position(3208, 3210, 0),
		    new Position(3215, 3211, 0),
		    ...
		    new Position(3238, 3225, 0),
		    new Position(3248, 3225, 0),
		    new Position(3254, 3225, 0),
		    new Position(3259, 3230, 0),
		    new Position(3256, 3239, 0),
		    new Position(3253, 3248, 0),
		    new Position(3251, 3253, 0),
		    new Position(3247, 3262, 0),
		    new Position(3243, 3271, 0),
		    new Position(3239, 3280, 0),
		    new Position(3238, 3284, 0),
		    new Position(3238, 3294, 0),
		    new Position(3238, 3304, 0),
		    new Position(3245, 3311, 0),
		    new Position(3252, 3318, 0),
		    new Position(3256, 3324, 0),
		    new Position(3266, 3326, 0),
		    new Position(3268, 3327, 0),
		    new Position(3269, 3337, 0),
		    new Position(3270, 3343, 0),
		    new Position(3272, 3348, 0),
		    new Position(3271, 3353, 0),
		    new Position(3271, 3363, 0),
		    new Position(3271, 3373, 0),
		    new Position(3272, 3373, 0)
		};
	
public static Area berryArea = new Area(3266, 3375, 3276, 3365);
	
	public static Position[] pathAToJ = {
		    new Position(3194, 3403, 0),
		    new Position(3189, 3403, 0),
		    new Position(3183, 3403, 0),
		    new Position(3181, 3413, 0),
		    new Position(3179, 3423, 0),
		    new Position(3178, 3428, 0),
		    new Position(3169, 3432, 0),
		    new Position(3165, 3433, 0)
		};
	
	public static Area d = new Area(3191, 3404, 3192, 3401);
	
	public static Area potionHouse = new Area(3192, 3406, 3198, 3402);
	
	public static Area outsidePotionHouse = new Area(
		    new int[][]{
		        { 3192, 3406 },
		        { 3190, 3406 },
		        { 3190, 3405 },
	...
	public static Position[] pathAToF = {
		    new Position(3255, 3478, 0),
		    new Position(3246, 3479, 0),
		    new Position(3243, 3469, 0),
		    new Position(3243, 3468, 0),
		    new Position(3238, 3459, 0),
		    new Position(3235, 3455, 0),
		    new Position(3229, 3447, 0),
		    new Position(3224, 3440, 0),
		    new Position(3219, 3432, 0),
		    new Position(3214, 3424, 0),
		    new Position(3211, 3420, 0),
		    new Position(3209, 3410, 0),
		    new Position(3209, 3408, 0),
		    new Position(3201, 3406, 0),
		    new Position(3195, 3400, 0),
		    new Position(3191, 3403, 0)
		};
	
	public static Area church = new Area(3252, 3484, 3259, 3471);
	
	public static Position[] pathRToF = {
		    new Position(3212, 3428, 0),
		    new Position(3219, 3435, 0),
		    new Position(3221, 3438, 0),
		    new Position(3228, 3445, 0),
		    new Position(3230, 3447, 0),
		    new Position(3235, 3454, 0),
		    new Position(3240, 3463, 0),
		    new Position(3242, 3467, 0),
		    new Position(3246, 3475, 0),
		    new Position(3249, 3479, 0),
		    new Position(3255, 3479, 0)
		};
	
	public static Area areaOutsideJulietsHouse = new Area(3165, 3438, 3170, 3427);

	public static Area firstFloorOfJulietsHouse = new Area(
			new int[][] { { 3165, 3439 }, { 3165, 3428 }, { 3164, 3427 }, { 3150, 3427 }, { 3149, 3428 },
					{ 3149, 3441 }, { 3150, 3442 }, { 3161, 3442 }, { 3161, 3440 }, { 3164, 3440 } });
	
	public static Area nextToStartJulietshouseGroundFloor = new Area(3159, 3436, 3159, 3435);
	
	public static Area a = new Area(3161, 3435, 3168, 3431);
	
	public static Area secondFloorOfJulietsHouseRoom1 = new Area(3151, 3439, 3158, 3431).setPlane(1);
	
	public static Area b = new Area(3155, 3432, 3158, 3429).setPlane(1);

	public static Area secondFloorOfJulietsHouseRoom2 = new Area(
		    new int[][]{
		        { 3153, 3431 },
		        { 3153, 3427 },
		        { 3164, 3427 },
	...
	public static Area c = new Area(3155, 3428, 3160, 3425).setPlane(1);
	
	public static Area balcony = new Area(3155, 3426, 3161, 3425).setPlane(1);
	
	public static Position[] pathJToR = {
		    new Position(3166, 3433, 0),
		    new Position(3176, 3431, 0),
		    new Position(3182, 3429, 0),
	...
	public static Position balcony1  = new Position(3157, 3425, 1);
	
	public static Area romeoArea = new Area(3201, 3439, 3224, 3418);
